import { ArrowLeft, Loader2, Send, Sparkles, Wrench } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <header className="flex items-center justify-between px-7 py-4 border-b-[0.5px] border-border">
        ...
        <Button variant="outline" size="sm" onClick={() => void startNew()}>
          New chat
        </Button>
      </header>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex items-end gap-2">
            ...
            <div className="flex flex-col gap-2">
              <VoiceButton onTranscript={(text) => setDraft((d) => (d ? `${d} ${text}` : text))} />
