...
pub fn provider_catalog() -> Vec<ProviderMetadata> {
    vec![
        ...
        ProviderMetadata {
            ...
            available_models: &["glm-4-flash", "glm-4-air", "glm-4-plus", "glm-4-long"],
        ...
        ProviderMetadata {
            ...
            available_models: &["MiniMax-Text-01", "abab6.5-chat", "abab6.5s-chat"],
        ...
        ProviderMetadata {
            id: "openai_compat",
            display_name: "OpenAI-Compat (custom gateway)",
            category: ProviderCategory::Advanced,
            api_format: ApiFormat::OpenAiCompatible,
            default_model: "auto",
            available_models: &["auto"],
            default_endpoint: "https://your-gateway.example.com/v1/chat/completions",
            allow_custom_endpoint: true,
            requires_api_key: true,
            api_key_url: None,
            featured: false,
        ...
        ProviderMetadata {
            ...
            category: ProviderCategory::Local,
            api_format: ApiFormat::Cli,
            default_model: "auto",
            available_models: &["auto"],
            default_endpoint: "claude",
            allow_custom_endpoint: false,
            requires_api_key: false,
            api_key_url: Some("https://code.claude.com/docs/en/quickstart"),
            featured: true,
            status: ProviderStatus::Available,
        },
        ProviderMetadata {
            ...
            allow_custom_endpoint: false,
            requires_api_key: false,
            api_key_url: Some("https://github.com/openai/codex"),
            featured: false,
            status: ProviderStatus::Available,
        },
        ProviderMetadata {
            ...
            allow_custom_endpoint: false,
            requires_api_key: false,
            api_key_url: Some("https://github.com/google-gemini/gemini-cli"),
            featured: false,
            status: ProviderStatus::Available,
        },
        ProviderMetadata {
            ...
            default_model: "auto",
            available_models: &["auto"],
            default_endpoint: "hermes",
            allow_custom_endpoint: false,
            requires_api_key: false,
            api_key_url: Some("https://hermes-agent.nousresearch.com/"),
            featured: false,
            status: ProviderStatus::Available,
        },
    ]
